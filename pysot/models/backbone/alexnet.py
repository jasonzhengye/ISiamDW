...
class AlexNetLegacy(nn.Module):
    ...
    def __init__(self, width_mult=1):
        ...
        #self.irmb = iRMB(256,256)
        #self.jason = AxialImageTransformer(
        dim=256,
        depth=12,
        reversible=True
        #).cuda()
        #self.out = PagFM(256,128)
        #self.conv = nn.Conv2d(256*3,256,1)

        self.block = PPA(in_features=256, filters=256)  # in_features：输入通道数，filters：输出通道数
